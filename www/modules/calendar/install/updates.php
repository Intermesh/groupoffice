...
$updates['201810161450'][] = "ALTER TABLE `cf_cal_events` CHANGE `model_id` `id` INT(11) NULL DEFAULT NULL;";
$updates['201810161450'][] = "RENAME TABLE `cf_cal_events` TO `cal_events_custom_fields`;";
$updates['201810161450'][] = "delete from cal_events_custom_fields where id not in (select id from cal_events);";
$updates['201810161450'][] = "ALTER TABLE `cal_events_custom_fields` ADD FOREIGN KEY (`id`) REFERENCES `cal_events`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT;";


$updates['201810161450'][] = "ALTER TABLE `cf_cal_calendars` CHANGE `model_id` `id` INT(11) NULL DEFAULT NULL;";
$updates['201810161450'][] = "RENAME TABLE `cf_cal_calendars` TO `cal_calendars_custom_fields`;";
$updates['201810161450'][] = "delete from cal_calendars_custom_fields where id not in (select id from cal_calendars);";
$updates['201810161450'][] = "ALTER TABLE `cal_calendars_custom_fields` ADD FOREIGN KEY (`id`) REFERENCES `cal_calendars`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT;";
