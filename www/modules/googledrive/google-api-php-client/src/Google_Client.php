...
class Google_Client {
   ...
   * @param StringHelper $accessToken JSON encoded string containing in the following format:
   ...
   * @param StringHelper $authClassName
   */
   ...
   * @return StringHelper $accessToken JSON encoded string in the following format:
   * {"access_token":"TOKEN", "refresh_token":"TOKEN", "token_type":"Bearer",
   *  "expires_in":3600,"id_token":"TOKEN", "created":1320790426}
   */
   ...
   * @param StringHelper $developerKey
   */
  ...
  /**
   * @param StringHelper $accessType Possible values for access_type include:
  ...
  /**
   * @param StringHelper $approvalPrompt Possible values for approval_prompt include:
   ...
   * @param StringHelper $applicationName
   */
   ...
   * @param StringHelper $clientSecret
   */
   ...
   * @param StringHelper $redirectUri
   */
   ...
   * @param StringHelper $refreshToken
   * @return void
   */
   ...
   * @param StringHelper|null $token The token (access token or a refresh token) that should be revoked.
   ...
   * isn't provided.
   * @throws Google_AuthException
   * @param StringHelper|null $token The token (id_token) that should be verified.
