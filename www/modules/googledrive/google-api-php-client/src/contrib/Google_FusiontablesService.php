 ...
 */
  ...
  class Google_ColumnServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $tableId Table for which a new column is being added.
     ...
     *
     * @param StringHelper $tableId Table to which the column belongs.
     * @param StringHelper $columnId Name or identifier for the column that is being requested.
     * @param array $optParams Optional parameters.
     * @return Google_Column
     */
     ...
     *
     * @param StringHelper $tableId Table whose columns are being listed.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $tableId Table for which the column is being updated.
     * @param StringHelper $columnId Name or identifier for the column that is being updated.
     * @param Google_Column $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Column
     */
     ...
     *
     * @param StringHelper $tableId Table from which the column is being deleted.
     * @param StringHelper $columnId Name or identifier for the column being deleted.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_QueryServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $sql An SQL SELECT/SHOW/DESCRIBE statement.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $sql An SQL SELECT/SHOW/DESCRIBE/INSERT/UPDATE/DELETE statement.
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool typed Should typed values be returned in the (JSON) response -- numbers for numeric values and parsed geometries for KML values? Default is true.
     * @opt_param bool hdrs Should column names be included (in the first row)?. Default is true.
  ...
  class Google_StyleServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $tableId Table for which a new style is being added
     ...
     *
     * @param StringHelper $tableId Table to which the requested style belongs
     ...
     *
     * @param StringHelper $tableId Table whose styles are being listed
     * @param array $optParams Optional parameters.
     *
     * @opt_param string pageToken Continuation token specifying which result page to return. Optional.
     ...
     *
     * @param StringHelper $tableId Table whose style is being updated.
     ...
     *
     * @param StringHelper $tableId Table from which the style is being deleted
  ...
  class Google_TemplateServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $tableId Table for which a new template is being created
     ...
     *
     * @param StringHelper $tableId Table to which the template belongs
     ...
     *
     * @param StringHelper $tableId Identifier for the table whose templates are being requested
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $tableId Table to which the updated template belongs
     ...
     *
     * @param StringHelper $tableId Table from which the template is being deleted
  ...
  class Google_TableServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $tableId Identifier(ID) for the table being requested.
     * @param array $optParams Optional parameters.
     * @return Google_Table
     */
     ...
     *
     * @param StringHelper $tableId Id of the table that is being updated.
     * @param Google_Table $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $tableId Id of the table that is being deleted.
     * @param array $optParams Optional parameters.
     */
