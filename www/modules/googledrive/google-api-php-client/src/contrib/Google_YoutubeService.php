 ...
 */
  ...
  class Google_ChannelsServiceResource extends Google_ServiceResource {
     ...
     * (channels.list)
     *
     * @param StringHelper $part Parts of the channel resource to be returned.
  ...
  class Google_PlaylistitemsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $part Parts of the playlist resource to be returned.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_PlaylistsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $id YouTube IDs of the playlists to be returned.
     * @param StringHelper $part Parts of the playlist resource to be returned.
     * @param array $optParams Optional parameters.
  ...
  class Google_VideosServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $id YouTube IDs of the videos to be returned.
     * @param StringHelper $part Parts of the video resource to be returned.
     * @param array $optParams Optional parameters.
