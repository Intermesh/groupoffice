 ...
 */
  ...
  class Google_FilesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $fileId The ID of the file to untrash.
     * @param array $optParams Optional parameters.
     * @return Google_DriveFile
     */
     ...
     *
     * @param StringHelper $fileId The ID of the file to trash.
     * @param array $optParams Optional parameters.
     * @return Google_DriveFile
     */
     ...
     *
     * @param StringHelper $fileId The ID for the file in question.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $fileId The ID of the file to update.
     * @param Google_DriveFile $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool convert Whether to convert this file to the corresponding Google Docs format.
     ...
     *
     * @param StringHelper $fileId The ID of the file to copy.
     * @param Google_DriveFile $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool convert Whether to convert this file to the corresponding Google Docs format.
     ...
     *
     * @param StringHelper $fileId The ID of the file to delete.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_AppsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $appId The ID of the app.
     * @param array $optParams Optional parameters.
     * @return Google_App
     */
  ...
  class Google_ParentsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $fileId The ID of the file.
     ...
     *
     * @param StringHelper $fileId The ID of the file.
     * @param StringHelper $parentId The ID of the parent.
     * @param array $optParams Optional parameters.
     * @return Google_ParentReference
     */
  ...
  class Google_RevisionsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $fileId The ID for the file.
     * @param StringHelper $revisionId The ID for the revision.
     ...
     *
     * @param StringHelper $fileId The ID of the file.
     * @param StringHelper $revisionId The ID of the revision.
     * @param array $optParams Optional parameters.
     * @return Google_Revision
     */
  ...
  class Google_ChangesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $changeId The ID of the change.
     * @param array $optParams Optional parameters.
  ...
  class Google_ChildrenServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $folderId The ID of the folder.
     ...
     *
     * @param StringHelper $folderId The ID of the folder.
     * @param StringHelper $childId The ID of the child.
     * @param array $optParams Optional parameters.
     * @return Google_ChildReference
     */
  ...
  class Google_PermissionsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $fileId The ID for the file.
     * @param StringHelper $permissionId The ID for the permission.
     * @param array $optParams Optional parameters.
     * @return Google_Permission
     */
