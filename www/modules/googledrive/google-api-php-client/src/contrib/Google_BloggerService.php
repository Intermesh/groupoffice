 ...
 */
  ...
  class Google_BlogsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId ID of the user whose blogs are to be fetched. Either the word 'self' (sans quote marks) or the user's profile identifier.
     ...
     *
     * @param StringHelper $blogId The ID of the blog to get.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_PostsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $blogId ID of the blog to fetch the post from.
     ...
     *
     * @param StringHelper $blogId ID of the blog to fetch the post from.
     * @param StringHelper $postId The ID of the post
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $blogId ID of the blog to fetch posts from.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $blogId The ID of the Blog.
     * @param StringHelper $postId The ID of the Post.
     * @param Google_Post $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Post
  ...
  class Google_PagesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $blogId ID of the blog to fetch pages from.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $blogId ID of the blog containing the page.
     * @param StringHelper $pageId The ID of the page to get.
     * @param array $optParams Optional parameters.
     * @return Google_Page
     */
  ...
  class Google_CommentsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $blogId ID of the blog to fetch comments from.
     * @param StringHelper $postId ID of the post to fetch posts from.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $blogId ID of the blog to containing the comment.
     * @param StringHelper $postId ID of the post to fetch posts from.
     * @param StringHelper $commentId The ID of the comment to get.
     * @param array $optParams Optional parameters.
  ...
  class Google_UsersServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId The ID of the user to get.
     * @param array $optParams Optional parameters.
     * @return Google_User
     */
