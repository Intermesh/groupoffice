 ...
 */
  ...
  class Google_TaskqueuesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue The id of the taskqueue to get the properties of.
  ...
  class Google_TasksServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $project The project under which the queue lies
     * @param StringHelper $taskqueue The taskqueue to insert the task into
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue The taskqueue in which the task belongs.
     * @param StringHelper $task The task to get properties of.
     * @param array $optParams Optional parameters.
     * @return Google_Task
     */
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue The id of the taskqueue to list tasks from.
     * @param array $optParams Optional parameters.
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue
     * @param StringHelper $task
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue The taskqueue to delete a task from.
     * @param StringHelper $task The id of the task to delete.
     * @param array $optParams Optional parameters.
     */
     ...
     *
     * @param StringHelper $project The project under which the queue lies.
     * @param StringHelper $taskqueue The taskqueue to lease a task from.
