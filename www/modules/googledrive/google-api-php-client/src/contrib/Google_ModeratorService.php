 ...
 */
  ...
  class Google_VotesServiceResource extends Google_ServiceResource {
     ...
     * series. (votes.insert)
     *
     * @param StringHelper $seriesId The decimal ID of the Series.
     * @param StringHelper $submissionId The decimal ID of the Submission within the Series.
  ...
  class Google_ResponsesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $seriesId The decimal ID of the Series.
     * @param StringHelper $topicId The decimal ID of the Topic within the Series.
     * @param StringHelper $parentSubmissionId The decimal ID of the parent Submission within the Series.
