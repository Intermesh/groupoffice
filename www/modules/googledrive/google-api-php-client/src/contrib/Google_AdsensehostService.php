 ...
 */
  ...
  class Google_UrlchannelsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $adClientId Ad client to which the new URL channel will be added.
     ...
     *
     * @param StringHelper $adClientId Ad client for which to list URL channels.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $adClientId Ad client from which to delete the URL channel.
     * @param StringHelper $urlChannelId URL channel to delete.
     * @param array $optParams Optional parameters.
     * @return Google_UrlChannel
     */
  ...
  class Google_AdclientsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $adClientId Ad client to get.
     * @param array $optParams Optional parameters.
  ...
  class Google_AssociationsessionsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $productCode Products to associate with the user.
     * @param StringHelper $websiteUrl The URL of the user's hosted website.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $token The token returned to the association callback URL.
     * @param array $optParams Optional parameters.
     * @return Google_AssociationSession
     */
  ...
  class Google_ReportsServiceResource extends Google_ServiceResource {
     ...
     * (reports.generate)
     *
     * @param StringHelper $endDate End of the date range to report on in "YYYY-MM-DD" format, inclusive.
     * @param StringHelper $startDate Start of the date range to report on in "YYYY-MM-DD" format, inclusive.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_AccountsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $filterAdClientId Ad clients to list accounts for.
     * @param array $optParams Optional parameters.
     ...
     *
     * @param StringHelper $accountId Account to get information about.
     * @param array $optParams Optional parameters.
  ...
  class Google_AccountsAdunitsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $accountId Account which will contain the ad unit.
     * @param StringHelper $adClientId Ad client into which to insert the ad unit.
     ...
     *
     * @param StringHelper $accountId Account which contains the ad unit.
     * @param StringHelper $adClientId Ad client for which to get ad unit.
     * @param StringHelper $adUnitId Ad unit to get.
     * @param array $optParams Optional parameters.
     * @return Google_AdUnit
     */
     ...
     * (adunits.getAdCode)
     *
     * @param StringHelper $accountId Account which contains the ad client.
     * @param StringHelper $adClientId Ad client with contains the ad unit.
     * @param StringHelper $adUnitId Ad unit to get the code for.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $accountId Account which contains the ad client.
     * @param StringHelper $adClientId Ad client for which to list ad units.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $accountId Account which contains the ad client.
     * @param StringHelper $adClientId Ad client which contains the ad unit.
     * @param Google_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return Google_AdUnit
     */
     ...
     * @param StringHelper $accountId Account which contains the ad unit.
     * @param StringHelper $adClientId Ad client for which to get ad unit.
     * @param StringHelper $adUnitId Ad unit to delete.
     * @param array $optParams Optional parameters.
     * @return Google_AdUnit
     */
  ...
  class Google_AccountsAdclientsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $accountId Account for which to list ad clients.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string pageToken A continuation token, used to page through ad clients. To retrieve the next page, set this parameter to the value of "nextPageToken" from the previous response.
     * @opt_param string maxResults The maximum number of ad clients to include in the response, used for paging.
  ...
  class Google_AccountsReportsServiceResource extends Google_ServiceResource {
     ...
     * (reports.generate)
     *
     * @param StringHelper $accountId Hosted account upon which to report.
     * @param StringHelper $startDate Start of the date range to report on in "YYYY-MM-DD" format, inclusive.
     * @param StringHelper $endDate End of the date range to report on in "YYYY-MM-DD" format, inclusive.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_CustomchannelsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $adClientId Ad client to which the new custom channel will be added.
     ...
     *
     * @param StringHelper $adClientId Ad client from which to get the custom channel.
     * @param StringHelper $customChannelId Custom channel to get.
     * @param array $optParams Optional parameters.
     * @return Google_CustomChannel
     */
     ...
     *
     * @param StringHelper $adClientId Ad client for which to list custom channels.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $adClientId Ad client in which the custom channel will be updated.
     * @param Google_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return Google_CustomChannel
     */
     ...
     *
     * @param StringHelper $adClientId Ad client from which to delete the custom channel.
     * @param StringHelper $customChannelId Custom channel to delete.
     * @param array $optParams Optional parameters.
     * @return Google_CustomChannel
     */
