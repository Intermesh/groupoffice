 ...
 */
  ...
  class Google_CommunityMembersServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $userId ID of the user.
  ...
  class Google_ActivitiesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId The ID of the user whose activities will be listed. Can be me to refer to the viewer (i.e. the authenticated user).
     ...
     *
     * @param StringHelper $activityId ID of the activity to remove.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_CommunityPollCommentsServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $pollId The ID of the poll being commented.
     ...
     * @param StringHelper $pollId The ID of the community whose polls will be listed.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string pageToken A continuation token that allows pagination.
  ...
  class Google_CommunityPollsServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $pollId The ID of the poll to get.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
  ...
  class Google_CommunityMessagesServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $topicId The ID of the topic the message should be added to.
     ...
     * @param StringHelper $topicId The ID of the topic which messages will be listed.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string pageToken A continuation token that allows pagination.
     ...
     * @param StringHelper $topicId The ID of the topic whose message will be moved to the trash folder.
     * @param StringHelper $messageId The ID of the message to be moved to the trash folder.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_CommunityTopicsServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $topicId The ID of the topic to get.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return Google_CommunityTopic
     ...
     * @param StringHelper $topicId The ID of the topic to be moved to the trash folder.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_CommentsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $activityId The ID of the activity to contain the new comment.
     ...
     *
     * @param StringHelper $commentId ID of the comment to get.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return Google_Comment
     ...
     *
     * @param StringHelper $activityId The ID of the activity containing the comments.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $commentId ID of the comment to remove.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_AclServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $activityId ID of the activity.
     * @param StringHelper $userId ID of the user to be removed from the activity.
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_CommunityPollVotesServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $pollId The ID of the poll being voted.
  ...
  class Google_CommunitiesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId The ID of the user whose communities will be listed. Can be me to refer to caller.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_ActivityVisibilityServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $activityId ID of the activity to get the visibility.
     * @param array $optParams Optional parameters.
     * @return Google_Visibility
     */
  ...
  class Google_BadgesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId The id of the user whose badges will be listed. Can be me to refer to caller.
     * @param array $optParams Optional parameters.
     ...
     *
     * @param StringHelper $userId The ID of the user whose badges will be listed. Can be me to refer to caller.
     * @param StringHelper $badgeId The ID of the badge that will be retrieved.
     * @param array $optParams Optional parameters.
     * @return Google_Badge
     */
  ...
  class Google_CountersServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId The ID of the user whose counters will be listed. Can be me to refer to caller.
     * @param array $optParams Optional parameters.
