 ...
 */
  ...
  class Google_LicenseAssignmentsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $productId Name for product
     * @param StringHelper $skuId Name for sku
     ...
     * @param StringHelper $productId Name for product
     * @param StringHelper $skuId Name for sku
     * @param StringHelper $userId email id or unique Id of the user
     * @param array $optParams Optional parameters.
     * @return Google_LicenseAssignment
     */
     ...
     * @param StringHelper $productId Name for product
     * @param StringHelper $skuId Name for sku
     * @param StringHelper $customerId CustomerId represents the customer for whom licenseassignments are queried
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $productId Name for product
     * @param StringHelper $skuId Name for sku for which license would be revoked
     * @param StringHelper $userId email id or unique Id of the user
