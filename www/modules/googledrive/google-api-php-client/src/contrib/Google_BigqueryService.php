 ...
 */
  ...
  class Google_TablesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $projectId Project ID of the new table
     * @param StringHelper $datasetId Dataset ID of the new table
     ...
     *
     * @param StringHelper $projectId Project ID of the requested table
     * @param StringHelper $datasetId Dataset ID of the requested table
     * @param StringHelper $tableId Table ID of the requested table
     * @param array $optParams Optional parameters.
     * @return Google_Table
     */
     ...
     *
     * @param StringHelper $projectId Project ID of the tables to list
     * @param StringHelper $datasetId Dataset ID of the tables to list
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $projectId Project ID of the table to update
     * @param StringHelper $datasetId Dataset ID of the table to update
     * @param StringHelper $tableId Table ID of the table to update
     * @param Google_Table $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Table
     */
     ...
     *
     * @param StringHelper $projectId Project ID of the table to delete
     * @param StringHelper $datasetId Dataset ID of the table to delete
     * @param StringHelper $tableId Table ID of the table to delete
     * @param array $optParams Optional parameters.
     */
  ...
  class Google_DatasetsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $projectId Project ID of the new dataset
     ...
     *
     * @param StringHelper $projectId Project ID of the requested dataset
     * @param StringHelper $datasetId Dataset ID of the requested dataset
     * @param array $optParams Optional parameters.
     * @return Google_Dataset
     */
     ...
     *
     * @param StringHelper $projectId Project ID of the datasets to be listed
     * @param array $optParams Optional parameters.
     *
     * @opt_param string pageToken Page token, returned by a previous call, to request the next page of results
     ...
     * (datasets.update)
     *
     * @param StringHelper $projectId Project ID of the dataset being updated
     * @param StringHelper $datasetId Dataset ID of the dataset being updated
     * @param Google_Dataset $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Dataset
     */
     ...
     *
     * @param StringHelper $projectId Project ID of the dataset being deleted
     * @param StringHelper $datasetId Dataset ID of dataset being deleted
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_JobsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $projectId Project ID of the project that will be billed for the job
     ...
     *
     * @param StringHelper $projectId Project ID of the project billed for the query
     ...
     *
     * @param StringHelper $projectId Project ID of the jobs to list
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $projectId Project ID of the query job
     * @param StringHelper $jobId Job ID of the query job
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $projectId Project ID of the requested job
     * @param StringHelper $jobId Job ID of the requested job
     * @param array $optParams Optional parameters.
     * @return Google_Job
     */
  ...
  class Google_TabledataServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $projectId Project ID of the table to read
     * @param StringHelper $datasetId Dataset ID of the table to read
     * @param StringHelper $tableId Table ID of the table to read
     * @param array $optParams Optional parameters.
     *
     * @opt_param string maxResults Maximum number of results to return
