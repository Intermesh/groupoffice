 ...
 */
  ...
  class Google_LocationServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $locationId Timestamp of the location to read (ms since epoch).
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $locationId Timestamp of the location to delete (ms since epoch).
     * @param array $optParams Optional parameters.
     */
