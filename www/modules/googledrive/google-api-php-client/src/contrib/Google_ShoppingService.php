 ...
 */
  ...
  class Google_ProductsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $source Query source
     ...
     *
     * @param StringHelper $source Query source
     * @param StringHelper $accountId Merchant center account id
     * @param StringHelper $productIdType Type of productId
     * @param StringHelper $productId Id of product
     * @param array $optParams Optional parameters.
     *
     * @opt_param string categories.include Category specification
