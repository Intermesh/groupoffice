 ...
 */
  ...
  class Google_ObjectAccessControlsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $bucket Name of a bucket.
     * @param StringHelper $object Name of the object.
     ...
     * @param StringHelper $bucket Name of a bucket.
     * @param StringHelper $object Name of the object.
     * @param StringHelper $entity The entity holding the permission. Can be user-userId, group-groupId, allUsers, or allAuthenticatedUsers.
     * @param array $optParams Optional parameters.
     * @return Google_ObjectAccessControl
     */
  ...
  class Google_ObjectsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $bucket Name of the bucket in which to store the new object. Overrides the provided object metadata's bucket value, if any.
     ...
     *
     * @param StringHelper $bucket Name of the bucket in which the object resides.
     * @param StringHelper $object Name of the object.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $bucket Name of the bucket in which to look for objects.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_BucketsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $projectId A valid API project identifier.
     * @param array $optParams Optional parameters.
     *
