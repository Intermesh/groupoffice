 ...
 */
  ...
  class Google_LayersServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $volumeId The volume to retrieve layers for.
     ...
     *
     * @param StringHelper $volumeId The volume to retrieve layers for.
     * @param StringHelper $summaryId The ID for the layer to get the summary for.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @opt_param string contentVersion The content version for the requested volume.
  ...
  class Google_LayersAnnotationDataServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $volumeId The volume to retrieve annotation data for.
     * @param StringHelper $layerId The ID for the layer to get the annotation data.
     * @param StringHelper $contentVersion The content version for the requested volume.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $volumeId The volume to retrieve annotations for.
     * @param StringHelper $layerId The ID for the layer to get the annotations.
     * @param StringHelper $annotationDataId The ID of the annotation data to retrieve.
     * @param StringHelper $contentVersion The content version for the volume you are trying to retrieve.
     * @param array $optParams Optional parameters.
     *
     * @opt_param int scale The requested scale for the image.
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
  ...
  class Google_LayersVolumeAnnotationsServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $volumeId The volume to retrieve annotations for.
     * @param StringHelper $layerId The ID for the layer to get the annotations.
     * @param StringHelper $annotationId The ID of the volume annotation to retrieve.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
     * @opt_param string source String to identify the originator of this request.
  ...
  class Google_BookshelvesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId ID of user for whom to retrieve bookshelves.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     ...
     *
     * @param StringHelper $userId ID of user for whom to retrieve bookshelves.
     * @param StringHelper $shelf ID of bookshelf to retrieve.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
  ...
  class Google_BookshelvesVolumesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $userId ID of user for whom to retrieve bookshelf volumes.
     * @param StringHelper $shelf ID of bookshelf to retrieve volumes.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_MyconfigServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $volumeIds The volume(s) to release restrictions for.
     * @param StringHelper $cpksver The device/version ID from which to release the restriction.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $source String to identify the originator of this request.
     * @param StringHelper $volumeId The volume to request concurrent/download restrictions for.
     * @param StringHelper $nonce The client nonce value.
     * @param StringHelper $cpksver The device/version ID from which to request the restrictions.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string locale ISO-639-1, ISO-3166-1 codes for message localization, i.e. en_US.
  ...
  class Google_VolumesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $q Full-text search query string.
     * @param array $optParams Optional parameters.
     *
     ...
     *
     * @param StringHelper $volumeId ID of volume to retrieve.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
  ...
  class Google_VolumesAssociatedServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $volumeId ID of the source volume.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string projection Restrict information returned to a set of selected fields.
     * @opt_param string maxResults Maximum number of results to return.
  ...
  class Google_MylibraryBookshelvesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $shelf ID of bookshelf from which to remove a volume.
     * @param StringHelper $volumeId ID of volume to remove.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     */
     ...
     *
     * @param StringHelper $shelf ID of bookshelf to which to add a volume.
     * @param StringHelper $volumeId ID of volume to add.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     */
     ...
     *
     * @param StringHelper $shelf ID of bookshelf with the volume.
     * @param StringHelper $volumeId ID of volume to move.
  ...
  class Google_MylibraryBookshelvesVolumesServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $shelf The bookshelf ID or name retrieve volumes for.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string projection Restrict information returned to a set of selected fields.
     * @opt_param string country ISO-3166-1 code to override the IP-based location.
  ...
  class Google_MylibraryReadingpositionsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $volumeId ID of volume for which to update the reading position.
     * @param StringHelper $timestamp RFC 3339 UTC format timestamp associated with this reading position.
     * @param StringHelper $position Position string for the new volume reading position.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     ...
     *
     * @param StringHelper $volumeId ID of volume for which to retrieve a reading position.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
  ...
  class Google_MylibraryAnnotationsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $annotationId The ID for the annotation to retrieve.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @return Google_Annotation
     ...
     *
     * @param StringHelper $annotationId The ID for the annotation to update.
     * @param Google_Annotation $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     ...
     *
     * @param StringHelper $annotationId The ID for the annotation to delete.
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     */
