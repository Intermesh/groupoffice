 ...
 */
  ...
  class Google_DirectDealsServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $id The direct deal id
     * @param array $optParams Optional parameters.
  ...
  class Google_CreativesServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $buyerCreativeId The buyer-specific id for this creative.
     * @param StringHelper $adgroupId The adgroup this creative belongs to.
     * @param array $optParams Optional parameters.
     * @return Google_Creative
     */
