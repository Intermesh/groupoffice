 ...
 */
  ...
  class Google_AdvertisersServiceResource extends Google_ServiceResource {
     ...
     * (advertisers.list)
     *
     * @param StringHelper $role The role of the requester. Valid values: 'advertisers' or 'publishers'.
     * @param StringHelper $roleId The ID of the requesting advertiser or publisher.
  ...
  class Google_CcOffersServiceResource extends Google_ServiceResource {
     ...
     *
     * @param StringHelper $publisher The ID of the publisher in question.
     * @param array $optParams Optional parameters.
     *
  ...
  class Google_LinksServiceResource extends Google_ServiceResource {
     ...
     * @param StringHelper $role The role of the requester. Valid values: 'advertisers' or 'publishers'.
     * @param StringHelper $roleId The ID of the requesting advertiser or publisher.
     * @param StringHelper $linkId The ID of the link to look up.
     * @param array $optParams Optional parameters.
     * @return Google_Link
     */
