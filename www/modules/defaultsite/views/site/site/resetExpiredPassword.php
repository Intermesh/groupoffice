<div class="reset-password-page page">
	<div class="wrapper">
		...
		<?php else: ?>
			<h2><?php echo \GO::t('passwordExpired', 'defaultsite'); ?></h2>
		<?php endif; ?>
		...
		<?php else: ?>
			...
			<table class="table-reset-password">	
				<tr>
					<td colspan="2"><?php echo \GO::t('changePasswordRequiredText', 'defaultsite'); ?></td>
				</tr>
				<tr>
					<td><label><?php echo \GO::t('currentPassword', 'defaultsite'); ?> *:</label></td>
