...
$updates['201810161450'][] = "ALTER TABLE `cf_site_content` CHANGE `model_id` `id` INT(11) NULL DEFAULT NULL;";
...
$updates['201810161450'][] = "ALTER TABLE `cf_site_sites` CHANGE `model_id` `id` INT(11) NULL DEFAULT NULL;";
