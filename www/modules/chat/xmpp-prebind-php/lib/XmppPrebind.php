...
class XmppPrebind {
	 ...
	 *
	 * @param StringHelper $jabberHost Jabber Server Host
	 * @param StringHelper $boshUri    Full URI to the http-bind
	 * @param StringHelper $resource   Resource identifier
	 ...
	 *
	 * @param StringHelper $username Username without jabber host
	 * @param StringHelper $password Password
	 */
	 ...
	 * @return StringHelper Auth XML to send
	 */
	 ...
	 *
	 * @param StringHelper $gzData
	 * @return StringHelper|bool
	 */
	 ...
	 *
	 * @param StringHelper $jid Jid in form username@jabberHost/Resource
	 * @return StringHelper JID
	 */
	 ...
	 *
	 * @param StringHelper $jid
	 * @return StringHelper Node
	 */
