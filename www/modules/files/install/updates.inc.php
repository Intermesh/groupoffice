...
$updates['201810161450'][] = "ALTER TABLE `cf_fs_folders` CHANGE `model_id` `id` INT(11) NOT NULL;";
...
$updates['201810161450'][] = "ALTER TABLE `cf_fs_files` CHANGE `model_id` `id` INT(11) NOT NULL;";
