 ...
 * <p>Example code:</p>
 * <pre><code>
var myReader = new Ext.data.JmapReader({
 ...
 * <p>It is possible to change a JmapReader's metadata at any time by including
 ...
 * <p>To use this facility you would create the JmapReader like this:</p><pre><code>
var myReader = new Ext.data.JmapReader();
</code></pre>
 ...
 * the JmapReader will use as an argument to the
 ...
 * which the JmapReader will use to set the {@link Ext.data.Store}'s
 * {@link Ext.data.Store#sortInfo sortInfo} property</li>
 * <li>any custom properties needed</li>
 * </ul></div>
 *
 * @constructor
 * Create a new JmapReader
 ...
 */
go.data.JmapReader = function(meta, recordType){
    meta = meta || {};
    /**
...
Ext.applyIf(meta, {
    ...
    Ext.data.JmapReader.superclass.constructor.call(this, meta, recordType || meta.fields);
};
Ext.extend(Ext.data.JmapReader, Ext.data.DataReader, {
    /**
     * This JmapReader's metadata as passed to the constructor, or as passed in
...
//        if(!o) {
//            throw {message: 'JmapReader.read: Json object not found'};
//        }
//        return this.readRecords(o);
//    },

    /*
     * TODO: refactor code between JmapReader#readRecords, #readResponse into 1 method.
    ...
    readResponse : function(action, response) {
        ...
        if(!o) {
            throw new Ext.data.JmapReader.Error('response');
        }
        ...
        if (success && action === Ext.data.Api.actions.create) {
            ...
            if (def && Ext.isEmpty(root)) {
                throw new Ext.data.JmapReader.Error('root-empty', this.meta.root);
            }
            else if (!def) {
                throw new Ext.data.JmapReader.Error('root-undefined-response', this.meta.root);
            }
        }
        ...
        if (Ext.isEmpty(res.success)) {
            throw new Ext.data.JmapReader.Error('successProperty-response', this.meta.successProperty);
        }
        return res;
    },
...
/**
 * @class Ext.data.JmapReader.Error
 * Error class for JmapReader
 */
Ext.data.JmapReader.Error = Ext.extend(Ext.Error, {
    constructor : function(message, arg) {
        this.arg = arg;
        Ext.Error.call(this, message);
    },
    name : 'Ext.data.JmapReader'
});
Ext.apply(Ext.data.JmapReader.Error.prototype, {
    lang: {
        'response': 'An error occurred while json-decoding your server response',
        'successProperty-response': 'Could not locate your "successProperty" in your server response.  Please review your JmapReader config to ensure the config-property "successProperty" matches the property in your server-response.  See the JmapReader docs.',
        'root-undefined-config': 'Your JmapReader was configured without a "root" property.  Please review your JmapReader config and make sure to define the root property.  See the JmapReader docs.',
        'idProperty-undefined' : 'Your JmapReader was configured without an "idProperty"  Please review your JmapReader configuration and ensure the "idProperty" is set (e.g.: "id").  See the JmapReader docs.',
        'root-empty': 'Data was expected to be returned by the server in the "root" property of the response.  Please review your JmapReader configuration to ensure the "root" property matches that returned in the server-response.  See JmapReader docs.'
    }
});
