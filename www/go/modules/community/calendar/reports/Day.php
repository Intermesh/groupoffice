...
class Day extends Week {
	...
	public function Header() {
		...
		$this->Rect($this->leftMargin, 10, $pageWidth, 30,'DF', [], $this->greyFill);
	...
	public function drawEventsBackground() {
		...
		$this->SetFont('','B');
		$this->Cell($this->leftCol-$left, $this->rowHeight-$minus, $this->day->format('d. '), 0, 0);
		$this->SetFont('','');
		$this->SetX($x);
		$this->Cell($this->leftCol-$left, $this->rowHeight-$minus, $this->days_long[$this->day->format('N')-1], 0,1,'C');
		$this->SetX($x);
