...
$updates['201907161224'][] = 'ALTER TABLE `bookmarks_category` DROP FOREIGN KEY `bookmarks_category_ibfk_1`; ';
$updates['201907161224'][] = 'ALTER TABLE `bookmarks_category` ADD CONSTRAINT `bookmarks_category_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `core_user`(`id`) ON DELETE SET NULL ON UPDATE RESTRICT;';
