...
go.modules.community.pdfeditor.openPDF = function (fileId) {
	...
	const viewerUrl = 'go/modules/community/pdfeditor/views/pdf.js/web/viewer.html?fileId=' + fileId + '&security_token=' + GO.securityToken + '&CSRFToken=' + encodeURIComponent(go.User.session.CSRFToken) + '&file=' + encodeURIComponent(fileUrl);
