<?php
return array (
  'Get the code from the google authenticator app on your mobile device and fill it in below' => 'Szerezd be a kódot a Google Hitelesítő alkalmazás a mobil eszközön, és töltse ki az alábbi',
  'Code' => 'Kód',
  ...
  'Scan the QR code below to enable Google authenticator for your account.' => 'QR-kód beolvasásával követve engedélyezheti a Google Hitelesítő fiókját.',
