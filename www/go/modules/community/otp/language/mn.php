...
return array (
  ...
  'Scan the QR code below with the OTP Authenticator app on your mobile device, after that fill in the field below with the code generated in the app.' => 'Доорх QR кодыг мобайл төхөөрөмж дээрх OTP Authenticator програмаар сканнердаж, дараа нь апп-д үүсгэсэн кодыг оруулна уу.',
  'Get the code from the OTP Authenticator app on your mobile device and fill it in below' => 'мобайл төхөөрөмж дээрх OTP Authenticator програмаас кодоо аваад доор бөглөнө үү',
  'Code' => 'код',
  'Code is required' => 'Код шаардлагатай',
  'Invalid code' => 'Буруу код байна',
);
