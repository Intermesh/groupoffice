            ...
            tbar: [
                ...
                this.moreMenu = new Ext.Button({
                    ...
                    menu: [{
                            ...
                            text: t("Export"),
                            handler: function () {
                                go.util.exportToFile('Note', Object.assign(go.util.clone(this.noteGrid.store.baseParams), this.noteGrid.store.lastOptions.params, { limit: 0, position: 0 }), 'csv');
                            },
                            scope: this
                        }]
                })
...
go.modules.community.notes.NoteDialog = Ext.extend(go.form.Dialog, {
    ...
    modal: false,
    initFormItems: function () {
        var formFieldSets = go.customfields.CustomFields.getFormFieldSets("Note").filter(function (fs) { return !fs.fieldSet.isTab; }), fieldSetAnchor = formFieldSets.length ? '100% 80%' : '100% 100%';
        var items = [{
                xtype: 'fieldset',
