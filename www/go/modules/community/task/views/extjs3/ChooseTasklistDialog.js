go.modules.community.task.ChooseTasklistDialog = Ext.extend(Ext.Window, {
	...
	initComponent: function () {
        this.chooseTasklistGrid = new go.modules.community.task.ChooseTasklistGrid();
        ...
        go.modules.community.task.ChooseTasklistDialog.superclass.initComponent.call(this);
	}
});
