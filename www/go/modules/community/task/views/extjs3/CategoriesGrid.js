go.modules.community.task.CategoriesGrid = Ext.extend(go.grid.GridPanel, {
	viewConfig: {
		scrollOffset: 0,
		forceFit: true,
		autoFill: true
	...
	initComponent: function () {
		...
		go.modules.community.task.CategoriesGrid.superclass.initComponent.call(this);
	},
				...
				items: [
					{
						...
						handler: function() {
							Ext.MessageBox.confirm(t("Confirm delete"), t("Are you sure you want to delete this item?"), function (btn) {
								...
								go.Db.store("TasksCategory").set({destroy: [this.moreMenu.record.id]});
							}, this);
						},
						scope: this						
					}
