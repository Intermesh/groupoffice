...
/**
 * The controller for the Task entity
 *
...
class Task extends EntityController {
	...
	/**
	 * Handles the Task entity's Task/query command
	 * 
	 * @param array $params
	...
	/**
	 * Handles the Task entity's Task/get command
	 * 
	 * @param array $params
	...
	/**
	 * Handles the Task entity's Task/set command
	 * 
