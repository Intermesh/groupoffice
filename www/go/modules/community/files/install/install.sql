...
INSERT INTO `files_node` (`id`, `storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `comment`, `aclId`, `isLocked`, `isDirectory`) VALUES (-1, 0, 0, 'root', now(), now(), 1, 'Disk root', 0, 1, 1);
UPDATE `files_node` SET id = 0 WHERE id = -1;
SET foreign_key_checks = 1;


-- Global storage quota for GO
INSERT INTO `files_storage` (`id`,`modifiedAt`, `quota`, `usage`, `ownedBy`) VALUES ('1', now(), '1073741824', '0', NULL);

-- Storage for admin user
INSERT INTO `files_storage` (`id`, `modifiedAt`, `quota`, `usage`, `ownedBy`) VALUES ('2', now(),'1073741824', '0', 1);
INSERT INTO `files_node` (`storageId`,  `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isLocked`, `isDirectory`) VALUES ('2', '0', 'Admin home', now(), now(), '1', '1', '1', '1', '1');
INSERT INTO `files_node` (`storageId`,  `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('2', '1', 'first folder', now(), now(), '1', '1', '1', '1');
INSERT INTO `files_node` (`storageId`,  `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('2', '1', 'second folder', now(), now(), '1', '1', '1', '1');
INSERT INTO `files_node` (`storageId`,  `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('2', '1', 'thirth folder', now(), now(), '1', '1', '1', '1');
INSERT INTO `files_node` (`storageId`,  `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('2', '3', 'sub of second folder', now(), now(), '1', '1', '1', '1');

-- Storage for 2nd user
INSERT INTO `files_storage` (`id`, `modifiedAt`, `quota`, `usage`, `ownedBy`) VALUES ('3', now(),'1073741824', '0', 2);
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isLocked`, `isDirectory`) VALUES ('3', '0', 'User2 home', now(), now(), '1', '2', '1', '1', '1');
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('3', '6', 'User2 first folder', now(), now(), '2', '2', '1', '1');
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('3', '6', 'User2 second folder', now(), now(), '2', '2', '1', '1');
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('3', '6', 'User2 thirth folder', now(), now(), '2', '2', '1', '1');
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isDirectory`) VALUES ('3', '8', 'User2 sub of second folder', now(), now(), '2', '2', '1', '1');

-- Storage for project module
INSERT INTO `files_storage` (`id`,`modifiedAt`, `quota`, `usage`, `ownedBy`) VALUES ('4', now(),'1073741824', '0', NULL);
INSERT INTO `files_node` (`storageId`, `parentId`, `name`, `createdAt`, `modifiedAt`, `ownedBy`, `modifiedBy`, `aclId`, `isLocked`, `isDirectory`) VALUES ('4', '0', 'Projects home', now(), now(), NULL, NULL, '1', '1', '1');
