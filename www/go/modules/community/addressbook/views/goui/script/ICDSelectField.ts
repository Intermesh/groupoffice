import {Config, createComponent, SelectField, Store, t} from "@intermesh/goui";

export class ICDSelectField extends SelectField {
	constructor() {
		super();
		...
		this.valueField = "iso6523";
		this.textRenderer = (record) => {
			return record["scheme-name"];
		};
	}

	public filterCountries(countryCodes: string[]) {
		const filtered = icdList.filter(i => countryCodes.includes(i.country));
...
const icdList: Record<string, any>[] = [
	{
		schemeid: "FR:SIRENE",
		iso6523: "0002",
		country: "FR",
	...
	},
	{
		...
		usage: "A CVR number uniquely identifies a legal entity. CVR stands for \"Central Business Register\" and contains information about all registered companies in Denmark.",
		registrable: true,
	},
	{
		schemeid: "JP:SST",
...
export const icdselect = (config: Config<ICDSelectField>) => createComponent(new ICDSelectField(), config);