...
$updates['202311271130'][] = 'ALTER TABLE `addressbook_contact` CHANGE `lastName` `lastName` VARCHAR(255) DEFAULT NULL;';
$updates['202311271130'][] = "ALTER TABLE `addressbook_contact` CHANGE `name` `name` VARCHAR(255) DEFAULT '';";
