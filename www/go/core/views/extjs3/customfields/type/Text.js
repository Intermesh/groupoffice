...
go.modules.core.core.type.Text = Ext.extend(Ext.util.Observable, {
	 ...
	 */
	getDialog : function() {
		return new go.modules.core.core.type.TextDialog();
	},
...
go.modules.core.core.CustomFields.registerType(new go.modules.core.core.type.Text());
