...
CREATE TABLE `core_alert` (
                              ...
                              KEY `core_alert_core_principal_id_fk` (`createdBy`),
                              CONSTRAINT `core_alert_core_principal_id_fk` FOREIGN KEY (`createdBy`) REFERENCES `core_principal` (`id`) ON DELETE SET NULL,
