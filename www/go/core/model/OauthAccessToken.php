...
class OauthAccessToken extends Entity implements AccessTokenEntityInterface
{
	...
	{
		if($colName == "expiryDateTime") {
			return empty($value) ? null : new DateTimeImmutable($value);
		}
		return parent::castProperty($colName, $value); // TODO: Change the autogenerated stub
	}
