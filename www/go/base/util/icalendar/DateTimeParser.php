...
class DateTimeParser {
    ...
    static function parseDateTime($dt, DateTimeZone $tz = null) {
        ...
        if (!$result) {
            throw new \InvalidArgumentException('The supplied iCalendar datetime value is incorrect: ' . $dt);
        }
    ...
    static function parseDate($date, DateTimeZone $tz = null) {
        ...
        if (!$result) {
            throw new \InvalidArgumentException('The supplied iCalendar date value is incorrect: ' . $date);
        }
    ...
    static function parseDuration($duration, $asString = false) {
        ...
        if (!$result) {
            throw new \InvalidArgumentException('The supplied iCalendar duration value is incorrect: ' . $duration);
        }
    ...
    static function parseVCardDateTime($date) {
        ...
        if (!preg_match($regex, $date, $matches)) {
            ...
            if (!preg_match($regex, $date, $matches)) {
                throw new \Exception('Invalid vCard date-time string: ' . $date);
            }
    ...
    static function parseVCardTime($date) {
        ...
        if (!preg_match($regex, $date, $matches)) {
            ...
            if (!preg_match($regex, $date, $matches)) {
                throw new \Exception('Invalid vCard time string: ' . $date);
            }
